  ...
  <div class="containerpetugas">
    <form action="" method="post" class="row g-3"> 
      <div class="col-md-11 col-md-offet-1">
        ...
        <input class="form-control" type="text" name="nama_petugas" id="nama_petugas" placeholder="masukkan nama petugas" required>
      </div><br><br>
      <div class="col-md-11 col-md-offet-1">
        <label for="user_petugas" class="form-label namavaksin">Username Petugas</label>
          <input class="form-control" type="text" name="user_petugas" id="user_petugas" placeholder="masukkan username petugas" required>
      </div>
